const I18N_FR = {
    ...
    dictionary: {
        ...
        help_magnetize_param: "Aimanter la pointe du losange tronqué avec le sol",
        help_kr_param: "Rapport de la longueur des bords inférieurs sur celle des bords supérieurs d'un losange",
        help_set_rhombus_param: "Régler sur losange (équilatéral)",
        help_painting_param: "Peindre les faces en fonction des étiquettes ou peindre les spirales avec des couleurs différentes",
        help_zh_param: "Hauteur de la partie visible du zome avant génération des montants",
        help_tw_param: "Largeur des montants",
        help_tt_param: "Épaisseur des montants",
        help_am_param: "De gauche à droite :",
        help_am_param_1: "Direction de l'expansion de la charpente : ↑ vers l'extérieur ou ↓ l'intérieur",
        help_am_param_2: "Méthode d'assemblage",
        help_am_param_3: "Direction de l'assemblage : Sens horaire, anti-horaire ou aucun sens (SemiCone)",
        help_vp_param: "Hauteur du point de fuite (utilisé pour construire les méthodes 'GoodKarma' et 'Beveled')",
        help_zc_param: "Place le point de fuite sur le centre de gravité (basé sur l'intégralité du zome)",
        help_ft_param: "Ajoute une semelle basée sur l'épaisseur des montants",
        ...
        num_of_different_faces: "Nombre de faces de formes différentes",
        total_number_of_faces: "Nombre total de faces",
        widest_radius_of_faces: "Rayon maximum des faces",
