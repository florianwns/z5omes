(function () {
    class OBJExporter {
        parse(object, mtl_filename = "") {
            let output = '';
            output += 'mtllib ' + mtl_filename + '\n';
            ...
            function parseMesh(mesh) {
                ...
                // material
                if (material) {
                    const mat_name = (material.name !== '') ? material.name : 'material' + material.id;
                    output += 'usemtl ' + mat_name + '\n';
            ...
            let mtl_output = '';
            for (const mat_name in materials) {
